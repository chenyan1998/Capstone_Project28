...
RF_Individual_Report  = execute.new_results_individual 
# RF_Individual_Report.reset_index(inplace=True)
data_dict = RF_Individual_Report.to_dict("records")
# Insert collection
...
# Key will be the age category
# name of the report will be the dictionary key
